<template>
  <div class="add-smoothie container">
    ...
    <form @submit.prevent="addSmoothie">
      ...
      <div class="field" v-for="(ing, index) in ingredients">
        <label for="ingredient">Ingredient:</label>
        <input type="text" name="ingredient" value="" v-model="ingredients[index]">
        <i class="material-icons delete" @click="deleteIngredient(ing)">delete</i>
      </div>
      <div class="field add-ingredient">
        <label for="add-ingredient">Add an ingredient (tab)</label>
